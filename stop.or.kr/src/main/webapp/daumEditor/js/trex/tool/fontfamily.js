...
TrexConfig.addTool(
	"fontfamily", 
	{
		...
		useFavorite: _TRUE,
		options: [
            { label: TXMSG('@fontfamily.NanumGothic')+' (<span class="tx-txt">가나다라</span>)', title: TXMSG('@fontfamily.NanumGothic'), data: 'NanumGothic,AppleGothic,sans-serif', klass: 'tx-NanumGothic' },
