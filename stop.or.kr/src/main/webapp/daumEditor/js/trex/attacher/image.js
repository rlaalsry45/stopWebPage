...
TrexConfig.addAttacher(
	...
	{	
		...
		features: { left:250, top:65, width:400, height:165 },
...
Trex.Attachment.Image = Trex.Class.create({
	...
	getSaveHtml: function(data) {
		return "<img src=\"" + data.imageurl + "\" class=\"txc-image\" data-filename=\""+data.filename+"\" data-filesize=\""+data.filesize+"\"/>";
	},
	getDispHtml: function(data) {
		return "<img id=\"" + data.dispElId + "\" src=\"" + data.imageurl + "\" class=\"txc-image\" data-filename=\""+data.filename+"\" data-filesize=\""+data.filesize+"\"/>";
	},
