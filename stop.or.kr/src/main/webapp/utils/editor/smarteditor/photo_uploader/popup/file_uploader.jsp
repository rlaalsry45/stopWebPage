			...
			if(item.getSize() > 0) {
				...
				filename_ext = filename_ext.toLowerCase();
			   	...
			   	if(cnt == 0) {
					...
					//String dftFilePath = "/home/nypi/new_web/main/webapp";
					String cp=request.getContextPath();
		    		/* if(!dftFilePath.equals("")){
		    			cp=dftFilePath.split("wtpwebapps")[1];
		    		} */

		    		String filePath = dftFilePath + "/data/upload" + File.separator
		    		...
		    		return3 += "&sFileURL="+cp+"/data/upload/multiupload/" + realFileNm;
			   	}
			}else {
