...
<div id="content" class="contentswrap"> 
	...
	<ul class="tabmenu">			
				<li class="active"><a href="/brdfaq/boardfaqList.do?brd_id=BDIDX_2052vSKNl9W13r2V1FhfEm&srch_menu_nix=jKvk3h4P&selecttype=VIEW" target="_self">정책정보</a></li>				
				...
				<li><a href="/brdfaq/boardfaqListD.do?brd_id=BDIDX_2052vSKNl9W13r2V1FhfEm&srch_menu_nix=jKvk3h4P&" target="_self">홈페이지 장애</a></li>
	</ul>
	...
	<form:form name="reqForm" commandName = "boardfaqVO">
		<section id="content">
			...
			<form:hidden path="selecttype" value = "VIEW"/>
			
			<input type="hidden" id="selecttype" name="selecttype" value="VIEW" /> 
