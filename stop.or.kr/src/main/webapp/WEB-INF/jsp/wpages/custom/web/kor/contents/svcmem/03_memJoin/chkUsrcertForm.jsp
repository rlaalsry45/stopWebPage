...
<%
	...
	*********************************************************************************************************************************************/
	...
	└────────────────────────────────────────────────────────────────────
	*/
	String sReturnURL				= "https://www.nie.re.kr/IPIN/ipin_process.jsp"; 
...
<form name="reqForm" method="post" class="joinform">
<!-- 컨텐츠영역 -->

<div id="member_content">
	<div class="img_title">
		<h2><img src="${pageContext.request.contextPath}/main/images/custom/kor/member/txt_auth.gif" alt="국립생태원 회원가입 여부를 확인하고 온라인 상에서 익명 사용자로 인한 피해를 방지 및 악의적인 명의도용방지를 위하여 본인확인 절차가 필요합니다. 아래 인증방식 중 선택하여 본인확인을 진행해 주시기 바랍니다." /></h2>
	</div>
