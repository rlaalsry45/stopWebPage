...
<div class="story circle">
	<article class="list">
		<h2>여성폭력은 개인적인 일이 아닙니다.</h2>
		<p class="desc">
			<strong>지금,</strong>
			<span>피해자 지원 전문가들이<br /> 당신을 기다리고 있습니다. </span>
			<a href="#story">익명 상담하기</a>
		</p>
	</article>
...
<!-- //이야기 하기 -->
  ...
  <div id="contents" class="new-type">
	...
	<article class="quick-box">
		<ul>
			<li><a href="https://www.women1366.kr/_main/main.html" target="_blank" title="새창열림"><span class="img"><img src="${pageContext.request.contextPath}/images/kor/main/quick-img01.png" alt="" /></span><span class="text"><span>여성폭력 사이버 상담</span></span></a></li>
			...
			<li><a href="https://www.stop.or.kr/html/kor/support/intro.html" target="_blank" title="새창열림"><span class="img"><img src="${pageContext.request.contextPath}/images/kor/main/quick-img02.png" alt="" /></span><span class="text"><span>성희롱·성폭력<br />근절종합지원센터</span></span></a></li>
			<li><a href="https://d4u.stop.or.kr/" target="_blank" title="새창열림"><span class="img"><img src="${pageContext.request.contextPath}/images/kor/main/quick-img03.png" alt="" /></span><span class="text"><span>디지털 성범죄<br />피해자 지원센터</span></span></a></li>
