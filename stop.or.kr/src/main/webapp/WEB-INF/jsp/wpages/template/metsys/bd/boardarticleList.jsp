	...
	<div id="detail_content">
		...
		<div class="btn_area_right">
			<%-- <c:if test="${RWAUTH eq 'RWD' or RWAUTH eq 'RW'}"> --%>
				...
				<a href="${pageContext.request.contextPath}/brdartcl/boardarticleMoveView.do?brd_id=${SESS_BRD_INFO.brd_id}&srch_menu_nix=${ param.srch_menu_nix}&edomweivgp=A" class="btn_line"><spring:message code="BOARD.WRITE" /><%-- 글쓰기 --%></a>
			<%-- </c:if> --%>
