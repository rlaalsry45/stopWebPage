...
<div id="bannerzone">
	<ul>
		<li><a href="http://www.mogef.go.kr/cc/wcc/cc_wcc_f001.do" target="_blank"><img src="${pageContext.request.contextPath}/images/kor/layout/banner1.gif" alt="여성긴급전화 1366현황" /></a></li>
		<li><a href="https://shp.mogef.go.kr/shp/front/main.do" target="_blank"><img src="${pageContext.request.contextPath}/images/kor/layout/banner2.gif" alt="예방교육통합관리" /></a></li>
		<li><a href="https://www.safetyreport.go.kr/#main" target="_blank"><img src="${pageContext.request.contextPath}/images/kor/layout/banner3.gif" alt="안전신문고" /></a></li>
		<li><a href="https://1398.acrc.go.kr/hpg/cmm/min/hpgMain.do" target="_blank"><img src="${pageContext.request.contextPath}/images/kor/layout/banner4.gif" alt="청렴신문고" /></a></li>
		...
		<li><a href="https://www.kigepe.or.kr/kor/index.do" target="_blank"><img src="${pageContext.request.contextPath}/images/kor/layout/banner6.gif" alt="한국양성평등교육진흥원" /></a></li>
		<li><a href="http://www.kwdi.re.kr/index.kw?sgrp=S01&siteCmsCd=CM0001" target="_blank"><img src="${pageContext.request.contextPath}/images/kor/layout/banner7.gif" alt="한국여성정책연구원" /></a></li>
	</ul>
</div>
...
<div id="siteinfo">
	...
	<span><a href="${pageContext.request.contextPath}/modedg/contentsView.do?ucont_id=CTX000056&srch_menu_nix=Ak20GP4Z">개인정보처리방침</a></span>
	<span><a href="${pageContext.request.contextPath}/modedg/contentsView.do?ucont_id=CTX000057&srch_menu_nix=9e67SjA6">영상정보처리기기</a></span>
