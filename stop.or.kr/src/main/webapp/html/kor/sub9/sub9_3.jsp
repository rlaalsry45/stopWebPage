...
<div class="form-agree">
	...
	<p class="box1">
		<span class="form-set form-radio">
			<input id="agree1-1" name="agree1" type="radio">
			<label for="agree1-1">동의함</label>
		</span>
		
		<span class="form-set form-radio">
			<input id="agree1-2" name="agree1" type="radio">
			<label for="agree1-2">동의하지 않음</label>
		</span>
	</p>
</div>
...
<div class="form-agree">
	...
	<p class="box1">
		<span class="form-set form-radio">
			<input id="agree2-1" name="agree2" type="radio">
			<label for="agree2-1">동의함</label>
		</span>
		
		<span class="form-set form-radio">
			<input id="agree2-2" name="agree2" type="radio">
			<label for="agree2-2">동의하지 않음</label>
		</span>
	</p>
</div>
...
<div class="form-agree">
	...
	<p class="box1">
		<span class="form-set form-radio">
			<input id="agree2-1" name="agree3" type="radio">
			<label for="agree2-1">동의함</label>
		</span>
		
		<span class="form-set form-radio">
			<input id="agree2-2" name="agree3" type="radio">
			<label for="agree2-2">동의하지 않음</label>
		</span>
	</p>
</div>
...
<p class="btns txt-center">
	<a href="sub9_3_1_2.jsp" class="btn-l btn1">다음</a>
	<a href="" class="btn-l btn2">취소</a>
</p>
<!-- // -->
