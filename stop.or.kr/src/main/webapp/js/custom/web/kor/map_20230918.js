...
function listEvent2(idx) {
	...
	case 1: 
		html = '<dl><dt>인천시</dt><dd><ul>'
				...
				+ '<li class="title">성폭력 ·가정폭력 근절 홍보</li>'
				+ '<li class="comments">관내 편의점, 11월 중</li>'
				+ '<li class="title">여성폭력 추방주간 기념식</li>'
				+ '<li class="comments">인천여성가족재단 대강당, 11.25.(금)</li>'
				+ '<li class="title">성폭력·가정폭력 추방 캠페인</li>'
				+ '<li class="comments">정각사거리 11.30.(수)</li>'
				+ '</ul></dd></dl>'
		break;
	case 2: 
		html = '<dl><dt>서울시</dt><dd><ul>'
				...
				+ '<li class="title">불볍촬영 근절 및 성폭력·가정폭력 추방 합동 캠페인</li>'
				+ '<li class="comments">서초구청 지하철 역사, 11.30.(수)</li>'
				+ '<li class="title">직장내 성희롱 대응 정보 확산 캠페인</li>'
				+ '<li class="comments">온라인, 11.14.(월) ~ 12.12.(월)</li>'
				+ '<li class="title">서울시 청소년시설 연합거리 상담</li>'
				+ '<li class="comments">서대문구 창천공원, 11.18.(금)</li>'
				+ '<li class="underline"></li>'
				+ '<li class="marker"><strong class="txt_t">토론회</strong></li>'
	...
	case 3: 
		html = '<dl><dt>경기도</dt><dd><ul>'
				...
				+ '<li class="title">성폭력·가정폭력 추방 민·관 합동캠페인</li>'
				+ '<li class="comments">온라인/ 범계역, 11.23.(화)</li>'
				+ '<li class="title">여성폭력추방주간 캠페인</li>'
				+ '<li class="comments">기흥역광장, 11.28.(금)</li>'
				+ '<li class="title">여성폭력추방캠페인</li>'
				+ '<li class="comments">안양역 범계로데오, 11.28.(월)</li>'
				+ '<li class="title">2022 여성폭력 추방주간 캠페인</li>'
				+ '<li class="comments">평택역 광장, 12.2.(금)</li>'
				+ '</ul></dd></dl>'
		break;
	case 4: 
		html = '<dl><dt>세종시</dt><dd><ul>'
	...
	case 5: 
		html = '<dl><dt>대전시</dt><dd><ul>'
				...
				+ '<li class="comments">월평역 공간이음, 12.21(수)</li>'
				+ '</ul></dd></dl>'
		break;
	case 6: 
		html = '<dl><dt>광주시</dt><dd><ul>'
	...
	case 7: 
		html = '<dl><dt>대구시</dt><dd><ul>'
				...
				+ '<li class="title">성폭력·가정폭력추방주간 합동캠페인</li>'
				+ '<li class="comments">북비산네거리, 11.25.(금)</li>'
				+ '<li class="title">성폭력·가정폭력추방주간 합동캠페인</li>'
				+ '<li class="comments">서부고등학교 앞, 11.28.(월)</li>'
				+ '<li class="underline"></li>'
	...
	case 10: 
		html = '<dl><dt>충청북도</dt><dd><ul>'
				...
				+ '<li class="title">성매매 방지 현장점검 및 디지털 성범죄 예방 민·관 합동 캠페인</li>'
				+ '<li class="comments">용암광장 유흥주점, 11.25.(금)</li>'
				+ '<li class="title">가정폭력 예방 캠페인</li>'
				+ '<li class="comments">제천세명대학교, 11.29.(화)</li>'
				+ '<li class="title">성폭력·가정폭력 추방 캠페인</li>'
				+ '<li class="comments">옥현 농협군지부 일원, 증평 장뜰시장, 11.30.(수)</li>'
				+ '</ul></dd></dl>'
		break;
	case 11: 
		html = '<dl><dt>충청남도</dt><dd><ul>'
				...
				+ '<li class="title">여성폭력 추방주간 기념 캠페인</li>'
				+ '<li class="comments">천안 신세계백화점, 안면도 수산시장 등 11.25.(금)</li>'
				+ '<li class="title">성폭력·가정폭력 추방 합동 캠페인</li>'
				+ '<li class="comments">온양온천역 광장, 논산 내동사거리, 계룡 사러기 원형광장 등 , 11.29.(화)</li>'
				+ '<li class="underline"></li>'
	...
	case 12: 
		html = '<dl><dt>경상북도</dt><dd><ul>'
				...
				+ '<li class="title">여성폭력대응체계 강화를 위한 폭력예방캠페인</li>'
				+ '<li class="comments">안동시 일원, 11.11.(금)</li>'
				+ '<li class="title">여성폭력추방주간 캠페인</li>'
				+ '<li class="comments">울진시장, 11.17.(목)</li>'
				+ '</ul></dd></dl>'
		break;
	case 13: 
		html = '<dl><dt>전라북도</dt><dd><ul>'
		...
		break;
	case 14: 
		html = '<dl style="height:702px;"><dt>경상남도</dt><dd><ul>'
				+ '<li class="marker"><strong class="txt_t">캠페인</strong></li>'
				+ '<li class="title">여성폭력추방 캠페인</li>'
				+ '<li class="comments">창원시 합성동, 11.22.(화)</li>'
				+ '<li class="title">여성폭력없는 지역사회를 위한 유관기관 합동캠페인</li>'
				+ '<li class="comments">김해시 일대, 11.29.(화)</li>'
				+ '<li class="title">성폭력·가정폭력 합동캠페인</li>'
				+ '<li class="comments">하동시장 등, 11.22.(화)</li>'
				+ '<li class="title">여성폭력 추방주간 캠페인</li>'
				+ '<li class="comments">미수동 일대, 11.24.(목)</li>'
				+ '<li class="title">폭력예방캠페인</li>'
				+ '<li class="comments">영남루 주변, 11.25.(금)</li>'
				+ '<li class="title">성폭력·가정폭력추방주간 캠페인</li>'
				+ '<li class="comments">가야 전통시장,11.25.(금)</li>'
				+ '<li class="title">여성폭력추방주간캠페인</li>'
				+ '<li class="comments">거창읍 일대,12.1.(목)</li>'
				+ '<li class="underline"></li>'
				+ '<li class="marker"><strong class="txt_t">상영회</strong></li>'
				+ '<li class="title">여성인권 영화 "나를 깨우는 바람" 상영 및 감독과의 대화</li>'
				+ '<li class="comments">통영리스타트플랫폼, 11.25.(금)</li>'
				+ '<li class="title">가정폭력영화 "뼈아픈 진실" 상영</li>'
	...
	case 15: 
		html = '<dl><dt>전라남도</dt><dd><ul>'
				...
				+ '<li class="title">성폭력·가정폭력 합동 캠페인 </li>'
				+ '<li class="comments">강진 아트홀 근처, 11.24.(목)</li>'
				+ '<li class="title">여성폭력추방주간 아웃리치 캠페인</li>'
				+ '<li class="comments">함평공용터미털 일원, 11.28.(월)</li>'
				+ '</ul></dd></dl>'
		break;
	case 16: 
		html = '<dl><dt>부산시</dt><dd><ul>'
				...
				+ '<li class="title">성폭력·가정폭력 추방 캠페인</li>'
				+ '<li class="comments">부산역 광장, 광복로 일대, 11.25.(금)</li>'
				+ '<li class="title">여성폭력추방주간 자체 캠페인</li>'
				+ '<li class="comments">부산역 일대, 11.28.(월)</li>'
				+ '<li class="title">성폭력·가정폭력 추방 캠페인</li>'
				+ '<li class="comments">중앙동일대, 동대신교차로, 강서구청 등, 11.29.(화)</li>'
				+ '<li class="title">성폭력·가정폭력 추방 캠페인</li>'
				+ '<li class="comments">서구청 광장, 12.1.(금)</li>'
				+ '</ul></dd></dl>'
		break;
	case 17: 
		html = '<dl><dt>제주도</dt><dd><ul>'
				...
				+ '<li class="title">서귀포시 중앙로터리 가정·성폭력추방 연대캠페인</li>'
