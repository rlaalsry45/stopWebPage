 ...
 * 
 * @class [ContextPath] [egovframework.plani.template.survey.dao] [SrvypartDAO.java]
 *
 */
@Mapper
public interface SrvypartDAO {
   ...
   * @exception Exception
   */
  public Integer mergeSrvypart(SrvypartVO vo) throws Exception;
