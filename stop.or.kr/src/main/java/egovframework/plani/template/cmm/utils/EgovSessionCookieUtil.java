...
public class EgovSessionCookieUtil {
   ...
   * @throws Exception
   */
  public static void setSessionInvalidate(HttpServletRequest request) throws Exception {
   ...
   * @throws Exception
   */
  public static void setSessionAttribute(HttpServletRequest request, String keyStr, String valStr)
      throws Exception {
  ...
  /**
   * 쿠키생성 - 입력받은 분만큼 쿠키를 유지되도록 세팅한다. 쿠키의 유효시간을 5분으로 설정 =>(cookie.setMaxAge(60 * 5) 쿠키의 유효시간을 10일로 설정
