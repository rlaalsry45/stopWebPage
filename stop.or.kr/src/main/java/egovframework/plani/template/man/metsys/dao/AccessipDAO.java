 ...
 * IP관리에 관한 CRUD를 처리한다.
 * 
 * @class [ContextPath] [egovframework.plani.template.man.metsys.dao] [AccessipDAO.java]
 *
 */
@Mapper
